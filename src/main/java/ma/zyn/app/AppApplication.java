...
public class AppApplication {
    ...
    private void createEtatCommande(){
            EtatCommande itemSuccess = new EtatCommande();
            itemSuccess.setStyle("success");
            itemSuccess.setLibelle("Payer");
            itemSuccess.setCode("Payer");
            etatCommandeService.create(itemSuccess);
            EtatCommande itemWarning  = new EtatCommande();
            itemWarning .setStyle("warning ");
            itemWarning .setLibelle("En cours");
            itemWarning .setCode("En cours");
            etatCommandeService.create(itemWarning );
            EtatCommande itemDanger = new EtatCommande();
            itemDanger.setStyle("danger");
            itemDanger.setLibelle("Non Payer");
            itemDanger.setCode("Non Payer");
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("CommandeItem"));
