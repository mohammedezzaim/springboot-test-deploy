...
public class CommandeRestAdmin {
    ...
    @Operation(summary = "Finds a commande by code")
    @GetMapping("code/{code}")
    public ResponseEntity<CommandeDto> findByCode(@PathVariable String code) {
	    Commande t = service.findByReferenceEntity(new Commande(code));
        if (t != null) {
            converter.init(true);
            CommandeDto dto = converter.toDto(t);
            return getDtoResponseEntity(dto);
    ...
    @Operation(summary = "find by etatComande code")
    @GetMapping("etatComande/code/{code}")
    public List<CommandeDto> findByEtatComandeCode(@PathVariable String code){
        return findDtos(service.findByEtatComandeCode(code));
    }
    @Operation(summary = "delete by etatComande code")
    @DeleteMapping("etatComande/code/{code}")
    public int deleteByEtatComandeCode(@PathVariable String code){
        return service.deleteByEtatComandeCode(code);
    }
